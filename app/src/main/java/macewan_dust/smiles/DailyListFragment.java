...
// generating some items for testing                                                                    /////-------- refactor this
        ...
        DailyItem temp2 = new DailyItem(R.drawable.icon_movement, R.drawable.border_image,
                getString(R.string.title_quest_movement), "Measure your movement", new InputMovementFragment());
        DailyItem temp3 = new DailyItem(R.drawable.icon_imagination, R.drawable.border_image,
                getString(R.string.title_quest_imagination), "Rate your imagination", new InputImaginationFragment());
        DailyItem temp4 = new DailyItem(R.drawable.icon_laughter, R.drawable.border_image,
        ...
        DailyItem temp6 = new DailyItem(R.drawable.icon_speaking, R.drawable.border_image,
